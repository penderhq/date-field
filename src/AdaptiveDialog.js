                            ...
                            {({ placement, ref, style }) => (
                                <Portal mobile={false} onClose={this.props.onClose}>
                                    <div ref={ref} style={style} data-placement={placement}>
                                        <Popover placement={placement} maxWidth={this.props.popoverMaxWidth} width={this.props.referenceElement.clientWidth} onClose={this.props.onClose}>
                                            <Component {...this.props} mobile={false} />
                                        </Popover>
                                    </div>
                                </Portal>
                            )}
                    ...
                    <Portal mobile={false} onClose={this.props.onClose}>
                        <Fader onClose={this.props.onClose}>
                            <Popover onClose={this.props.onClose}>
                                <Component {...this.props} mobile={true} />
                            </Popover>
                        </Fader>
                    </Portal>
                </React.Fragment>
